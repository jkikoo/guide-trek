...
Cette priorité reste une solution imparfaite quand l’orage est actif : elle réduit pluie, vent et froid, mais ne transforme pas la tente en protection foudre.
...
## Abri perdu, inutilisable ou partagé

La perte de tente ne doit pas produire une recommandation unique. Faire demi-tour peut être mauvais si le retour est long, plus exposé, déjà dégradé par l’eau ou trop tardif.

Ordre d’analyse :

1. Protéger immédiatement personne froide, téléphone, batterie, couches sèches et couchage encore utilisable.
2. Chercher une protection réelle : autre groupe, cabane ouverte, auvent, tarp, sursac, poncho, couverture de survie utilisée comme coupe-vent, relief abrité sans danger supérieur.
3. Évaluer si cette protection permet de tenir assez longtemps pour reprendre de la marge.
4. Comparer ensuite retour, échappatoire, bivouac de fortune et appel à l’aide.
5. Refuser une marche longue si quelqu’un est trempé, froid et sans amélioration durable.

Le partage d’abri n’est pas une solution idéale, mais peut être la meilleure décision si elle évite une marche exposée de nuit ou sous refroidissement.
...
- Ne jamais proposer « faire demi-tour » après perte d’abri sans comparer durée, terrain, froid, heure et protection de fortune.
- Ne jamais présenter un camp stable comme une victoire définitive : sous météo dégradée, il reste sous surveillance.
