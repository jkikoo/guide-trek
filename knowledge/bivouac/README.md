...
### Animaux, nourriture et odeurs

Un site apparemment bon peut devenir mauvais si nourriture, déchets, popote ou objets odorants restent près du couchage. Les traces, restes, odeurs fortes ou activité animale proche imposent de traiter ce point avant le confort.

1. Garder nourriture et déchets sous contrôle immédiat.
2. Séparer couchage, cuisine et stockage selon les règles locales et le terrain.
3. Ne pas cuisiner dans l’espace de sommeil.
4. Ne pas dormir avec nourriture, déchets ou objets odorants non sécurisés.
5. Changer de site si l’activité animale est proche et que le stockage crédible n’est pas possible.
...
- Ne jamais valider un camp avec odeurs, nourriture ou déchets non sécurisés dans l’espace de sommeil.
...
- traces, odeurs, restes ou activité animale proche ;
- nourriture, déchets et objets odorants sécurisables ;
